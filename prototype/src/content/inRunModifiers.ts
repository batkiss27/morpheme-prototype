...
export const inRunModifiers: InRunModifierSpec[] = [
  ...
  { id: 'momentum', name: 'Momentum', rarity: 'uncommon', category: 'scoring', effect: 'Each natural extension round adds a permanent +0.05 to the multiplier base.', hookId: 'momentum', params: { perRound: 0.05 } },
  ...
  { id: 'agglutination', name: 'Agglutination', rarity: 'exotic', category: 'scoring', effect: 'Morpheme multiplier base +0.1.', hookId: 'agglutination', params: { bonus: 0.1 } },
  ...
  { id: 'chain_lightning', name: 'Chain Lightning', rarity: 'relic', category: 'extension', effect: 'Extension cards grant +0.1 to the multiplier base instead of causing strain.', hookId: 'chain_lightning', params: { bonus: 0.1 } },
