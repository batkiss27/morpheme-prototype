...
| P7-06 | As a winner I can enable challenge modifiers. | After first WIN, LexiconScreen shows challenge toggles granting loadout points; 4–5 implemented (Vowel Thief, Tight Clock, No Breath, Inflation). | 2 | P7-05 | todo |
